...
void LCD_PIC_DataBus(uint8_t a){
    ...
    if(a & 0x1) LATDbits.LATD0 = 1;else LATDbits.LATD0 = 0;
    if(a & 0x2) LATDbits.LATD1 = 1;else LATDbits.LATD1 = 0;
    if(a & 0x4) LATDbits.LATD2 = 1;else LATDbits.LATD2 = 0;
    if(a & 0x8) LATDbits.LATD3 = 1;else LATDbits.LATD3 = 0;
}
void LCD_PIC_Cmd(uint8_t a){
    LATEbits.LATE2 = 0;
    LATEbits.LATE2 = 1;
...
void LCD_PIC_Init(void){
    ...
    TRISD &= ~((1<<0)|(1<<1)|(1<<2)|(1<<3));
    ANSELD &= ~((1<<0)|(1<<1)|(1<<2)|(1<<3));
    WPUD &= ~((1<<0)|(1<<1)|(1<<2)|(1<<3));
    INLVLD &= ~((1<<0)|(1<<1)|(1<<2)|(1<<3));
    ODCOND &= ~((1<<0)|(1<<1)|(1<<2)|(1<<3));
    SLRCOND |= (1<<0)|(1<<1)|(1<<2)|(1<<3 );
