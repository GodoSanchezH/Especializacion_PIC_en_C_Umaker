...
# 32 "C:/Program Files/Microchip/MPLABX/v5.50/packs/Microchip/PIC18Fxxxx_DFP/1.2.26/xc8\\pic\\include\\xc.h" 3
# 1 "C:/Program Files/Microchip/MPLABX/v5.50/packs/Microchip/PIC18Fxxxx_DFP/1.2.26/xc8\\pic\\include\\pic18.h" 1 3
...
uint16_t data_sine[201] = {2141,2346,2004,2547,2205,2409,2613,2270,2811,2468,2670,2872,2527,3066,2719,2919,3117,2769,3303,2953,3148,3342,2989,3518,3163,3352,3541,3182,3705,3344,3527,3709,3343,3860,3491,3667,3842,3469,3978,3602,3770,3937,3556,4057,3673,3833,3992,3602,4095,3702,3854,4004,3606,4091,3689,3833,3975,3568,4045,3635,3770,3904,3489,3958,3540,3667,3793,3371,3832,3407,3527,3646,3217,3670,3239,3352,3465,3030,3477,3040,3148,3255,2815,3257,2815,2919,3021,2577,3016,2570,2670,2770,2323,2759,2311,2409,2507,2058,2493,2044,2141,2238,1789,2224,1775,1873,1971,1523,1960,1512,1612,1712,1266,1705,1261,1363,1467,1025,1468,1027,1134,1242,805,1253,818,930,1043,612,1066,637,755,875,451,911,489,615,742,325,793,378,512,647,238,714,308,449,593,191,676,278,428,580,187,680,291,449,610,225,726,345,512,681,304,813,440,615,791,422,939,573,755,939,577,1101,741,930,1120,764,1294,940,1134,1329,979,1514,1165,1363,1563,1216,1755,1410,1612,1814,1471,2012,1669,1873,2077,1736,2278,1936,2141};
# 56 "main.c"
_Bool bandera=0;
typedef struct {
    uint16_t n[11];
...
# 122 "main.c"
                ...
                Temporal = 0*X.n[0]+ 0.00923785502710178*X.n[1] +0.0469909006979769*X.n[2] +0.120908856584527*X.n[3] ;
                Temporal += 0.203017095323730*X.n[4] +0.239690584733330*X.n[5] +0.203017095323730*X.n[6] +0.120908856584527*X.n[7];
                Temporal += 0.0469909006979769*X.n[8] +0.00923785502710178*X.n[9]+ 0*X.n[10];


                variable = (uint16_t)Temporal;
                Val_H = variable>>8;
                Val_L = variable;
                ...
                I2C_Start();
                I2C_Write_Address_Slave(0b11000000,0b00000000);
