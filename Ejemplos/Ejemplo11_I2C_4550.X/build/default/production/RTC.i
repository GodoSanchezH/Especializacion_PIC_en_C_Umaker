...
void DS1307_Write_Date(uint8_t dia_mes,uint8_t mes ,uint8_t year,uint8_t dia_semana) {
 ...
 void DS1307_Read_H_24(uint8_t *horas ,uint8_t *minutos,uint8_t *segundos){
     ...
     I2C_Write_Slave(0X00);
     I2C_Restart();
     I2C_Write_Slave(0XD1);
     I2C_ReadData(segundos,0b00000000);
     I2C_ReadData(minutos,0b00000000);
     I2C_ReadData(horas,0b00000001);
     I2C_Stop();
  ...
  void DS1307_Read_Date(uint8_t *year ,uint8_t *mes,uint8_t *dia_mes ,uint8_t *dia_semana){
     ...
     I2C_Restart();
     I2C_Write_Slave(0XD1);
     I2C_ReadData(dia_semana,0b00000000);
     I2C_ReadData(dia_mes,0b00000000);
     I2C_ReadData(mes,0b00000000);
     I2C_ReadData(year,0b00000001);
     I2C_Stop();
