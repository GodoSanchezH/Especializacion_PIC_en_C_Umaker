...
void LCD_PIC_DataBus(uint8_t a){
    ...
    if(a & 0x1) LATDbits.LATD4 = 1;else LATDbits.LATD4 = 0;
    if(a & 0x2) LATDbits.LATD5 = 1;else LATDbits.LATD5 = 0;
    if(a & 0x4) LATDbits.LATD6 = 1;else LATDbits.LATD6 = 0;
    if(a & 0x8) LATDbits.LATD7 = 1;else LATDbits.LATD7 = 0;
}
void LCD_PIC_Cmd(uint8_t a){
    LATDbits.LATD2 = 0;
    LATDbits.LATD2 = 1;
...
void LCD_PIC_Init(void){
    ...
    TRISD &= ~( (1<<2) | (1<<3)| (1<<4)| (1<<5)| (1<<6)| (1<<7));
    LATD &= ~( (1<<2) | (1<<3)| (1<<4)| (1<<5)| (1<<6)| (1<<7));
