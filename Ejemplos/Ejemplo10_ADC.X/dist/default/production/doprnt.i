...
# 1 "C:/Users/HP/.mchp_packs/Microchip/PIC18F-Q_DFP/1.14.237/xc8\\pic\\include\\inline.h" 1 3
...
static int vfpfcnvrt(FILE *fp, char *fmt[], va_list ap)
{
    ...
    if ((*fmt)[0] == '%') {
        ...
        flags = width = 0;
        prec = -1;
# 814 "C:\\Program Files\\Microchip\\xc8\\v2.32\\pic\\sources\\c99\\common\\doprnt.c"
        if (*fmt[0] == 'c') {
            ++*fmt;
